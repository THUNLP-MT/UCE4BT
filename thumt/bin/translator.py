...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        with open(args.output, "w") as outfile, open(args.prob_files[0], 'w') as out_word_prob,\
                open(args.prob_files[1], 'w') as out_sentence_prob:
            for outputs, scores, word_scores in \
                    zip(restored_outputs, restored_scores, restored_word_scores):
